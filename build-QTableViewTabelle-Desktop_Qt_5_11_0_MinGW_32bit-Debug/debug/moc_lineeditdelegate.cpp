...
#include "../../QTableViewTabelle/lineeditdelegate.h"
...
QT_MOC_LITERAL(3, 30, 8) // "newValue"
    ...
    "lineEditdelegate\0textChanged\0\0newValue"
};
...
void lineEditdelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = int (lineEditdelegate::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&lineEditdelegate::textChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject lineEditdelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_lineEditdelegate.data,
      qt_meta_data_lineEditdelegate,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
int lineEditdelegate::textChanged(const QString & _t1)
{
    int _t0{};
